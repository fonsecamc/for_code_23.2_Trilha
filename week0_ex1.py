#Dois primeiros parágrafos do site do Python na Wikipédia
c ="""Python é uma linguagem de programação de alto nível, [5] interpretada de script, imperativa, orientada a objetos, funcional, de tipagem dinâmica e forte.
Foi lançada por Guido van Rossum em 1991. [1]
...
#Substituição de Python por Fython
d = c.replace("Python", "Fython")
